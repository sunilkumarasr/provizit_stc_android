...
//    public static final String ROOT_URL1 = "https://stcapi.provizit.com/provizit/resources/";
    ...
    public class API_ENDPOINTS {
        ...
        public static final String getversions = "masters/getversions";

        public static final String checkuser = "useractions/checkuser";

        public static final String getuserDetails = "masters/getuserDetails";

        public static final String getEmployeeDetails = "company/getEmployeeDetails";
