...
public class DepartmentAdapter extends ArrayAdapter<CompanyData> {
    ...
    public DepartmentAdapter(Context context, int resource, int textViewResourceId, List<CompanyData> items, int status, String Comp_id, boolean... isMeetingroom) {
