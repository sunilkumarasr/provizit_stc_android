...
public class MeetingRoomFragmentCustomAdapter extends ArrayAdapter<CompanyData> {
    Context context;
    ...
    DatabaseHelper myDb;
    public MeetingRoomFragmentCustomAdapter(Context context, int resource, int textViewResourceId, List<CompanyData> items, int status, String Comp_id, boolean... isMeetingroom) {
