...
public class AllotParkingCategoryAdapter extends RecyclerView.Adapter<AllotParkingCategoryAdapter.ViewHolder>{
    ...
    public AllotParkingCategoryAdapter(ArrayList<CompanyData> my_data,  Context context, CustomItemCityListener customItemClick) {
