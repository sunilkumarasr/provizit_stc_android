...
public class WorkingDaysModal implements Serializable {

    private Integer result;
    private Float total_counts;
    private String incomplete_data;
    private ArrayList<WorkingDays> items;
    ...
    public ArrayList<WorkingDays> getItems() {
        return items;
    }

    public void setItems(ArrayList<WorkingDays> items) {
        this.items = items;
    }
