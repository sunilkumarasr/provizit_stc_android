package com.provizit.compactcalendarview;
...
import static com.provizit.compactcalendarview.CompactCalendarView.FILL_LARGE_INDICATOR;
import static com.provizit.compactcalendarview.CompactCalendarView.NO_FILL_LARGE_INDICATOR;
import static com.provizit.compactcalendarview.CompactCalendarView.SMALL_INDICATOR;
            ...
            if (dayRow == 0) {
                ...
                if (day <= 0) {
                    if (displayOtherMonthDays) {
                        ...
                        canvas.drawText(Conversions.convertToArabic(String.valueOf(maximumPreviousMonthDay + day)), xPosition, yPosition, dayPaint);
                    }
                    ...
                    if (displayOtherMonthDays) {
                        ...
                        dayPaint.setStyle(Paint.Style.FILL);
                        dayPaint.setColor(otherMonthDaysTextColor);
                        canvas.drawText((Conversions.convertToArabic(String.valueOf(day - maximumMonthDay))), xPosition, yPosition, dayPaint);
                    }
                } else {
                    dayPaint.setStyle(Paint.Style.FILL);
                    dayPaint.setColor(defaultCalenderTextColorToUse);
                    canvas.drawText((Conversions.convertToArabic(String.valueOf(day))), xPosition, yPosition, dayPaint);
                }
            }
        }
    }
